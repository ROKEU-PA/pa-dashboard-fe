  ...
  return (
    <div className="bg-[#F8F9FA] h-[830] w-full flex flex-col p-2 md:p-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4  items-stretch">
        <Card className="rounded-3xl bg-white h-[415px] shadow-sm relative border-none flex flex-col">
          <CardIcon
            icon={Leaf}
            bgClass="bg-[#E9F5DB]"
        ...
        <Card className="rounded-3xl bg-white shadow-sm h-[415px] relative border-none flex flex-col">
          <CardIcon
            icon={Database}
            bgClass="bg-[#E3F2FD]"
            ...
            <div className="flex justify-center w-full">
              <div className="grid grid-cols-2 gap-x-12 ">
                <LegendItem
                  color="#4FC3F7"
                  label="Total Aset"
                  value={dataAsset?.[0]?.value ?? "-"}
                />
                <LegendItem
                  color="#C0D756"
                  label="Kondisi Baik"
                  value={dataAsset?.[2]?.value ?? "-"}
                />
                <LegendItem
                  color="#FFB300"
                  label="Rusak Ringan"
                  value={dataAsset?.[3]?.value ?? "-"}
                />
                <LegendItem
                  color="#F50057"
                  label="Rusak berat"
                  value={dataAsset?.[4]?.value ?? "-"}
                />
                <div className="col-span-2 mt-1">
                  <LegendItem
                    color="#8E8E93"
                    label="Nilai Aset"
                    value={dataAsset?.[1]?.value ?? "-"}
                    isCurrency
                  />
                </div>
              </div>
